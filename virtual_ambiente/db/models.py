...
class Pessoa(Base):
    ...
    def __repr__(self):  # Quando for printar um elemento, o método é chamado pra aparecer na tela mais legível
...
Base.metadata.create_all(engine)  # Criando todas as tabelas.
